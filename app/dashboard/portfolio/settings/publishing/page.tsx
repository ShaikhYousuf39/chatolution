      ...
      <div className="flex">
        <aside className="w-56 border-r border-slate-200 px-6 py-6">
          ...
          <div className="mt-6 space-y-2">
            <a
              href="/dashboard/portfolio/settings/general"
                    ...
                    >
                      ...
                      <div className="text-right">
                        <button
                          ...
                          className="inline-flex h-[36px] w-[48px] items-center justify-center rounded-lg border border-slate-200 text-slate-500 hover:bg-slate-50"
                        >

                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.5168 1.43725C16.6107 1.29737 17.7167 1.7082 18.839 2.69018L19.0636 2.89331L19.0646 2.89526C20.2679 4.0332 20.8156 5.18731 20.7335 6.36303C20.6541 7.49952 19.9956 8.46196 19.2443 9.25561L19.2433 9.25463L11.0431 17.9343C10.8113 18.1886 10.4978 18.4052 10.2003 18.5642C9.90134 18.724 9.55528 18.861 9.23062 18.9187L9.22574 18.9197L6.00601 19.4685C5.22574 19.6028 4.4775 19.4086 3.94449 18.9031C3.41205 18.3981 3.17666 17.6612 3.26382 16.8767L3.2648 16.8748L3.63394 13.6345L3.63589 13.6208L3.68179 13.3738C3.74038 13.1247 3.83444 12.871 3.94058 12.6433C4.08178 12.3405 4.2751 12.0188 4.50308 11.7761L4.50406 11.7751L12.714 3.08471H12.715C13.4665 2.29087 14.3893 1.58146 15.5168 1.43725ZM15.7072 2.92553C15.0948 3.00384 14.4731 3.40926 13.8048 4.11499L5.59488 12.8054L5.5939 12.8044C5.51203 12.8922 5.4016 13.0612 5.30093 13.2771C5.20015 13.4932 5.14005 13.6928 5.1232 13.8191L4.75503 17.0447C4.71281 17.4289 4.832 17.6768 4.97671 17.8142C5.12101 17.951 5.37267 18.0564 5.7521 17.991H5.75308L8.96792 17.4412C9.09313 17.4189 9.28741 17.351 9.49331 17.241C9.7009 17.13 9.85753 17.0103 9.9357 16.9246L9.94449 16.9148L18.1544 8.22534V8.22436C18.8231 7.51802 19.1944 6.87453 19.2375 6.25854C19.2776 5.6822 19.0407 4.93725 18.0353 3.98608C17.0348 3.04479 16.2804 2.85223 15.7072 2.92553Z" fill="#566273" />
                            <path d="M11.7756 4.30881C12.1848 4.24519 12.5683 4.52559 12.632 4.93478C13.0093 7.35529 14.9739 9.20734 17.4162 9.45334C17.8283 9.49494 18.1286 9.86354 18.0871 10.2756C18.0454 10.6875 17.6778 10.9879 17.2658 10.9465C14.1483 10.6325 11.6325 8.26463 11.1496 5.16525C11.086 4.75606 11.3664 4.37256 11.7756 4.30881Z" fill="#566273" />
                            <path d="M21 21.25C21.4142 21.25 21.75 21.5858 21.75 22C21.75 22.4142 21.4142 22.75 21 22.75H3C2.58579 22.75 2.25 22.4142 2.25 22C2.25 21.5858 2.58579 21.25 3 21.25H21Z" fill="#566273" />
                          </svg>
